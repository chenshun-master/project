<?php /*a:1:{s:89:"D:\phpstudy\PHPTutorial\WWW\project\application\weixin\view\user\collection\like_tpl.html";i:1549940378;}*/ ?>
...
<div class="wl-img-3">
    <div class="wl-main href">
        <div>
            <div class="wl-tou-img href">
                <img src="<?php echo htmlentities($vo['portrait']); ?>" class="cus-article-href2" alt=""
    ...
    <div class="wl-neirong cus-click-href" data-id="<?php echo htmlentities($vo['id']); ?>" data-type="<?php echo htmlentities($vo['type']); ?>">
        ...
        <div class="wl-nei3">
            ...
            <img src="<?php echo htmlentities($v); ?>" alt="">
            <?php endforeach; ?>
        </div>
    </div>
    <ul class="wl-tubiao">
...
<div class="wl-neirong cus-click-href">
    <div class="wl-main href">
        <div>
            <div class="wl-tou-img href">
                <img src="<?php echo htmlentities($vo['portrait']); ?>" alt="" onerror='this.src="/static/image/user/tou.png"'
                     class="cus-article-href2" data-user_id="<?php echo htmlentities($vo['user_id']); ?>">
            </div>
            <div class="wl-tou-yonghu href">
                <dl><?php echo htmlentities($vo['nickname']); ?></dl>
                <dt><?php echo htmlentities(formatTime(strtotime($vo['published_time']))); ?></dt>
...
<div class="wl-img-1">
    <div class="wl-main href">
        <div>
            <div class="wl-tou-img href">
                <img src="<?php echo htmlentities($vo['portrait']); ?>" alt="" class="cus-article-href2"
                     onerror='this.src="/static/image/user/tou.png"' data-user_id="<?php echo htmlentities($vo['user_id']); ?>">
            </div>
            <div class="wl-tou-yonghu href">
                <dl><?php echo htmlentities($vo['nickname']); ?></dl>
...
<div style="width: 100%;min-height: 400px;border-bottom: 10px solid #EEEEEE;position: relative">
    ...
    <div class="wl-jh  cus-click-href" data-id="<?php echo htmlentities($vo['id']); ?>"  data-type="<?php echo htmlentities($vo['type']); ?>"><?php echo htmlentities($vo['title']); ?></div>
    <div class="wx-video">
