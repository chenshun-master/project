<?php /*a:4:{s:77:"D:\phpstudy\PHPTutorial\WWW\project\application\admin\view\layout\layout.html";i:1543493419;s:77:"D:\phpstudy\PHPTutorial\WWW\project\application\admin\view\layout\header.html";i:1543490758;s:75:"D:\phpstudy\PHPTutorial\WWW\project\application\admin\view\layout\left.html";i:1543493942;s:76:"D:\phpstudy\PHPTutorial\WWW\project\application\admin\view\layout\right.html";i:1543490313;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <!-- Morris chart -->
    <link rel="stylesheet" href="/static/admin/bower_components/morris.js/morris.css">
    <!-- jvectormap -->
    <link rel="stylesheet" href="/static/admin/bower_components/jvectormap/jquery-jvectormap.css">
    <!-- Date Picker -->
    <link rel="stylesheet" href="/static/admin/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
    <!-- Daterange picker -->
    <link rel="stylesheet" href="/static/admin/bower_components/bootstrap-daterangepicker/daterangepicker.css">
            ...
            <li class="active treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li class="active"><a href="<?php echo url('/admin/login/index/index'); ?>"><i class="fa fa-circle-o"></i> 你好</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
                ...
                <section class="col-lg-7 connectedSortable">
                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body chat" id="chat-box">
                            <!-- chat item -->
                            <div class="item">
                                <img src="/static/admin/dist/img/user4-128x128.jpg" alt="user image" class="online">
                            ...
                            <!-- chat item -->
                            <div class="item">
                                <img src="/static/admin/dist/img/user3-128x128.jpg" alt="user image" class="offline">
                            ...
                            <!-- chat item -->
                            <div class="item">
                                <img src="/static/admin/dist/img/user2-160x160.jpg" alt="user image" class="offline">
...
<!-- jQuery UI 1.11.4 -->
<script src="/static/admin/bower_components/jquery-ui/jquery-ui.min.js"></script>
...
<script src="/static/admin/bower_components/morris.js/morris.min.js"></script>
<!-- Sparkline -->
<script src="/static/admin/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
<!-- jvectormap -->
...
<!-- jQuery Knob Chart -->
<script src="/static/admin/bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
<!-- daterangepicker -->
