<?php /*a:1:{s:74:"D:\phpstudy\PHPTutorial\WWW\project\application\index\view\file\layout.html";i:1542593270;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="clip-content">
    <div class="upload-container choose-gallery">
        <div class="upload-pretty button-three-dimen">
            <input type="file" name="imgFile" id="targetImg">本地上传
        </div>
    </div>
