<?php /*a:1:{s:75:"D:\phpstudy\PHPTutorial\WWW\project\application\seller\view\index\main.html";i:1549961927;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <title> <?php echo config('conf.title'); ?> - 商户后台</title>
...
<div id="wrapper">
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a class="J_menuItem" href="/seller/index/index2"><i class="fa fa-home"></i><span class="nav-label">商户主页</span></a>
                </li>
                <li class="line dk"></li>
                <li class="hidden-folded padder m-t m-b-sm text-muted text-xs">
                ...
                <li>
                    <a href="/seller/shop/addGood" class="J_menuItem" ><i class="glyphicon glyphicon-check"></i> <span class="nav-label">添加商品</span></a>
                    <a href="/seller/shop/index" class="J_menuItem" ><i class="glyphicon glyphicon-shopping-cart"></i> <span class="nav-label">商品列表</span></a>
                    <a href="/seller/shop/goodsOrder" class="J_menuItem" ><i class="glyphicon glyphicon-th-large"></i> <span class="nav-label">我的订单</span></a>
                </li>
                <li class="line dk"></li>
                <li class="hidden-folded padder m-t m-b-sm text-muted text-xs">
                    <span class="ng-scope">我的管理</span>
                </li>
                <li>
                    <a href="/seller/diary/index" class="J_menuItem" ><i class="glyphicon glyphicon-credit-card"></i> <span class="nav-label">日记管理</span></a>
                    <?php if(($user_info['type'] == 4)): ?>
                        <a href="/seller/user/mydoctor" class="J_menuItem" ><i class="glyphicon glyphicon-user"></i> <span class="nav-label">医生管理</span></a>
                    <?php else: ?>
                        <a href="/seller/user/myhospital" class="J_menuItem" ><i class="iconfont icon-chakanyiyuan"></i> <span class="nav-label">医院管理</span></a>
                    <?php endif; ?>
                </li>
            </ul>
        </div>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe id="J_iframe" width="100%" height="100%" src="/seller/index/index2" frameborder="0" data-id="/seller/index/index2" seamless ></iframe>
        </div>
    </div>
</div>
