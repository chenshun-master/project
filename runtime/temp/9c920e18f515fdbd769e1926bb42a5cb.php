<?php /*a:2:{s:79:"D:\phpstudy\PHPTutorial\WWW\project\application\weixin\view\article\userme.html";i:1557217677;s:78:"D:\phpstudy\PHPTutorial\WWW\project\application\weixin\view\layout\layout.html";i:1549940378;}*/ ?>
<html>
<head>
...
<div class="wl-con" id="container">
    <div class="wl-top">
        ...
        <dl><img src="<?php echo htmlentities($user_info['portrait']); ?>" alt="" onerror="this.src='/static/image/user/tou.png '" ></dl>
        <dt><?php echo htmlentities($user_info['nickname']); ?></dt>
        <p><?php echo htmlentities($user_info['profile']); ?></p>
        <?php if($is_friend === true):?>
        <dd><a href="/weixin/user/userDialogue/uid/<?php echo htmlentities($user_info['id']); ?>">私信</a></dd>
...
<script>
    var listObj = {
        index:0,
        user_id:<?php echo htmlentities($user_info['id']); ?>,
        url:[
        ...
        submitFriendApply:function(){
            ...
            if(redream.isEmptyStr(remarks)){
                ...
                $.ajax({
                    ...
                    type: 'post',
                    data: {friend_id:<?php echo htmlentities($uid); ?>,remarks:remarks},
                    dataType: 'json',
                    beforeSend:function(){
